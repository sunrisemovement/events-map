...
class Rack::Directory::DirectoryBody < Anonymous_Struct_407
...
class Rack::Multipart::Parser::Collector::MimePart < Anonymous_Struct_408
  def get_data; end
end
...
class Rack::Session::Cookie::SessionId < Anonymous_Delegator_409
  def cookie_value; end
